				...
				<div class="col-md-10 columns">
					<div class="row">	
                        ...
                        <div class="col-md-2">
							...
							<select id="crm_user_filter" name="crm_user_filter"  class="form-control" required>
                                <option value="">---</option>
                                <?php   	                                					                            
			...
			<div class="table-responsive">
				...
				<table class="table table-hover main-table table-striped">
                    ...
                    if( $this->input->get_post('search_submit') ){                                              
                        ...
                        ?>
                            <tr>    
                                <td><?php echo $logs_row->log_type; ?></td>
                                <td><?php echo $logs_row->log_title; ?></td>
                                <td><?php echo $logs_row->log_details; ?></td>
                                <td><?php echo ( $this->system_model->isDateNotEmpty($logs_row->log_date) )?date('d/m/Y', strtotime($logs_row->log_date)):''; ?></td>															                                                            
                            </tr>
                        <?php                    
                        }     
                    }else{
                        echo "<tr><td colspan='100%'>Please filter first to show results</td></tr>";
                    }                                                                                      
					?>
					</tbody>
...
<div id="about_page_fb" class="fancybox" style="display:none;" >
	...
	<p>
<pre><code><?php echo $show_query; ?></code><pre>
    </p>
