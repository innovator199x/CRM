...
<div class="box-typical box-typical-padding">
	...
	$export_link_params = '/jobs/image_on_hold/?export=1&'.http_build_query($export_links_params_arr);
	?>
	...
	<header class="box-typical-header">
		...
		echo form_open('/jobs/image_on_hold',$form_attr);
		?>
				...
				<table class="table table-hover main-table">
					...
					<tbody>
						...
						<tr class="<?php echo $row_color; ?>">
							<td><?php echo ($this->system_model->isDateNotEmpty($list_item['start_date']))?$this->system_model->formatDate($list_item['start_date'],'d/m/Y'):''; ?></td>
							<td><?php echo $this->gherxlib->getAge($list_item['j_created']); ?></td>
							<td><?php echo $getRegion->subregion_name;?></td>
	...
	jQuery(document).ready(function(){
		...
		jQuery("#assign_btn").on('click',function(){
			...
			jQuery.ajax({
				...
				setTimeout(function(){ window.location='/jobs/image_on_hold'; }, <?php echo $this->config->item('timer') ?>);	
			});	
