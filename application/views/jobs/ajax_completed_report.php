...
/*	foreach( $job_types->result() as $job_type ){
	...
	if($this->config->item('country')==2){ // NZ REMOVED LR
		...
		if( $this->input->post('ajt_id') == 0){ //Add IC Upgrade 
			$ic_arr = 	array(
				'full'=>'IC Upgrade',
				'short'=>'IC Upgrade',
				'tot'=>0,
...
<div class="row">
    ...
    <div class="col-lg-12 columns">
        ...
        <thead>
		   ...
		   if( $this->input->post('ajt_id') == 0){ // Add 240v Rebook
		   ...
		   ?>
            ...
            ?>
                <tr style="background-color: <?php echo $val['bg_color']; ?>;">
                    <td class="f_col">
							...
							if( $this->input->post('ajt_id') == 0){ // Add EO Jobs
							...
							if( $this->input->post('ajt_id') == 0){ // Upfront Jobs
            ...
            <tr style="background-color:#DDDDDD">
						...
						<?php 
							...
							if( $this->input->post('ajt_id') == 0){ // Add 240v Rebook Total Completed
							?>
						...
						<?php 
							...
							if( $this->input->post('ajt_id') == 0){ // Add EO jobs Total Completed
							?>
								<td class="text-center" style="font-weight: bold">
						...
						if( $this->input->post('ajt_id') == 0){ // Add Upfront jobs Total Completed
						?>
							<td class="text-center" style="font-weight: bold">
    ...
    <div style="text-align:left;" class="table_top_head">Average Days to Complete</div>
        <table class="table table-hover main-table table_border">
			...
			?>
			<?php if( $this->input->post('ajt_id') == 0){
