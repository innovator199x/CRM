<div class="box-typical box-typical-padding">
	<?php 
		...
		$bc_items = array(
            ...
            array(
				'title' => 'Tool Details',
				'link' => "/vehicles/view_tool_details/{$this->uri->segment(4)}"
			),
			array(
				'title' => $title,
				'status' => 'active',
				'link' => "/vehicles/ladder_check_details/{$this->uri->segment(3)}/{$this->uri->segment('4')}"
            )
	...
	<section>
		...
		<?php
            ...
            echo form_open('/vehicles/ladder_check_update',$form_attr);
		?>
            ...
            <div class="col-md-5 columns">
                ...
                <div class="row" style="margin-bottom:20px;">
                        ...
                        <div class="col-md-3 columns">
                            <input type="text"  class="flatpickr form-control flatpickr-input" name="date" id="date" value="<?php echo date('d/m/Y',strtotime($lc['date'])); ?>" />
                        </div>
                        ...
                        <table style="width:auto;" id="tbl_ladder" class="tbl-sd table table-hover main-table table-sm">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><input data-aa="<?php echo $lis['value'] ?>" type="radio" class="jradio" name="ladder_opt<?php echo $li['ladder_inspection_id']; ?>" value="1" <?php echo ($lis['value']==1)?'checked="checked"':''; ?> /></td>
                                    <td><input data-aa="<?php echo $lis['value'] ?>" type="radio" class="jradio" name="ladder_opt<?php echo $li['ladder_inspection_id']; ?>" value="0" <?php echo ( is_numeric($lis['value']) && $lis['value']==0 )?'checked="checked"':''; ?> /></td>
                                </tr>
                            <?php	
                            }
                            ?>				
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 columns">
                        <input type="text"  class="flatpickr form-control flatpickr-input" name="inspection_due" id="inspection_due" value="<?php echo date('d/m/Y',strtotime($lc['inspection_due'])); ?>" readonly="readonly" />
                    </div>
                </div>
                ...
                <div class="row" style="margin-top: 20px;margin-bottom:20px;">
                  <div class="col-md-12 columns">
                    ...
                    <input type="submit" class="btn" id="btn_submit" style="float: left; width: auto;" value="Update" />
                  </div>
                </div>
...
<div id="about_page_fb" class="fancybox" style="display:none;" >
	...
	<p>
    This page allows you to view/update Ladder Check details.
	</p>
