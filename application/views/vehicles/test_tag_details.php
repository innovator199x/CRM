<div class="box-typical box-typical-padding">
	<?php 
		...
		$bc_items = array(
			...
			array(
				'title' => $title,
				'status' => 'active',
				'link' => "/vehicles/test_tag_details/{$test_and_tag_id}/{$tools_id}"
            )
	...
	<section>
		...
		<?php
            ...
            echo form_open("/vehicles/test_tag_update",$form_attr);
		?>
            ...
            <div class="col-md-5 columns">
                ...
                <div class="row form-group">
                        ...
                        <div class="col-md-3 columns">
                            <input type="text"  class="flatpickr form-control flatpickr-input" name="date" id="date" value="<?php echo date('d/m/Y',strtotime($tnt['date'])); ?>" />
                        </div>
			...
			<input type="radio" name="tnt_comp" value="0" style="width:auto; display:inline;" <?php echo ( is_numeric($tnt['tnt_completed']) && $tnt['tnt_completed']==0 )?'checked="checked"':''; ?> /> No
                ...
                <label class="col-md-4">Comment</label>
                    <div class="col-md-8 columns">
                        <textarea class="addtextarea form-control" style="width: 328px; height: 150px; margin:0; padding: 7px;" name="comment"><?php echo $tnt['comment']; ?></textarea>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-3 columns">
                        <input type="text"  class="form-control" name="inspection_due" id="inspection_due" value="<?php echo ($tnt['inspection_due']!='')?date('d/m/Y',strtotime($tnt['inspection_due'])):''; ?>" readonly="readonly" />
                    </div>
                </div>
                ...
                <div class="row" style="margin-top: 20px;margin-bottom:20px;">
                  <div class="col-md-12 columns">
                    ...
                    <input type="submit" name="btn_update_test_tag" class="btn" id="btn_submit" style="float: left; width: auto;" value="Update" />
                  </div>
                </div>
...
<div id="about_page_fb" class="fancybox" style="display:none;" >
	...
	<p>
   This page allows you to update Test and Tag details.
	</p>
