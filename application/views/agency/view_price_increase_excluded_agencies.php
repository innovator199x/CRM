...
$bc_items = array(
    ...
    array(
        'title' => $title,
        'status' => 'active',
        'link' => "/agency/view_price_increase_excluded_agencies"
    )
);
...
$export_link_params = '/agency/view_price_increase_excluded_agencies/?export=1&'.http_build_query($export_links_params_arr);
?>
	...
	<header class="box-typical-header">
        ...
        echo form_open('/agency/view_price_increase_excluded_agencies',$form_attr);
        ?>
					...
					<tbody>
							...
							?>
									<tr>
											...
											<td><?php echo $this->system_model->isDateNotEmpty($row['exclude_until']) ? $this->system_model->formatDate($row['exclude_until'],'d/m/y') : NULL;  ?></td>
