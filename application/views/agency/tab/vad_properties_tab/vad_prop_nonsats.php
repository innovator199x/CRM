<div role="tabpanel" class="tab-pane fade <?php echo ($this->input->get('prop_type')=='2')?'active show':'' ?>" id="vad_prop_tab_2">
						...
						<div class="table-responsive">
							<table class="table table-hover main-table">
								<thead>
									<tr>
										<th>Address</th>
										<th>Status (<span class="text-green"><?php echo $active_count; ?></span>/<span class="text-red"><?php echo $inactive_count; ?></span>)</th>
