                                    ...
                                    data: {
                                        ...
                                        if(data.status===true){
                                            swal({
                                                ...
                                                obj.parents('.loader_wrapper_pos_rel').find('.tenants_ajax_box').load('/properties/get_tenants_ajax #tenants_ajax_container',{prop_id:<?php echo $prop_id ?>}, function(response, status, xhr){
                                    ...
                                    data: {
                                     ...
                                     if(ret.status===true){
                                        ...
                                        swal({
                                                ...
                                                swal.close();
                                                node.parents('.loader_wrapper_pos_rel').find('.loader_block_v2').show();
                                                node.parents('.loader_wrapper_pos_rel').find('.tenants_ajax_box').load('/properties/get_tenants_ajax #tenants_ajax_container',{prop_id:<?php echo $prop_id ?>}, function(response, status, xhr){
