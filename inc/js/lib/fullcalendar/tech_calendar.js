            ...
            customButtons: {
                addNewButton: {
                  ...
                  click: function() {
                    ...
                    $.fancybox.open({
                        src: "/calendar/add_calendar_entry_static",
                        type: 'ajax'
                    })
                ...
                $('body').append(
                    ...
                    '<div class="fc-popover click">' +
                        ...
                        '<div class="fc-body main-screen">' +
                            ...
                            '<p><strong><em style="color:#fa424a"> <a data-fancybox data-type="ajax" data-src="'+calEvent.cal_url+'"  href="javascript:;">Edit</a></em></strong></p>' +
